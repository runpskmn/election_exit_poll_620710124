...
import 'package:election_exit_poll_620710124/models/api_result.dart';
...
class Api {
  ...
  Future<dynamic> submit(
    ...
    var url = Uri.parse('$BASE_URL/$endPoint'); print(params.toString());
    final response = await http.post(
      url,
      headers: {'Content-Type': 'application/json', 'id': '620710124'},
  ...
  Future<dynamic> fetch(
    ...
    final response = await http.get(url, headers: {'id': '620710124'},);
